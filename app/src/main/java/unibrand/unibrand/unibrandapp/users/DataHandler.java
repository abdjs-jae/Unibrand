...
import unibrand.unibrand.unibrandapp.MainActivity;
import unibrand.unibrand.unibrandapp.R;
import unibrand.unibrand.unibrandapp.RegisterActivity;
import unibrand.unibrand.unibrandapp.users.sqlite.SQLHelper;
import unibrand.unibrand.unibrandapp.users.sqlite.SQLiteSingleton;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if( responseJson.getInt("success") == 1 ){
                                setUserData(params);
                                ActivityHandler.afterSplashActivity(currentContext, RegisterActivity.class, MainActivity.class);
                            }else{
                                Alert.oops();
                            }
